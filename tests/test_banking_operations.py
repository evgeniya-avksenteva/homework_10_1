import pytest
from src.banking_operations import search_transactions, sort_transactions
...
def test_search_transactions(dictionaries):
    input_user = "Перевод"
    result = search_transactions(dictionaries, input_user)
