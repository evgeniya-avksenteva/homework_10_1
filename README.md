...
Модуль decorators
Данный модуль используется для размещения декораторов.
...
Функция transaction_amount:
- принимает на вход транзакцию и возвращает сумму транзакции в рублях

Функция currency_conversion:
- Функция конвертации суммы операции

Модуль transactions_file:
- Функция read_transaction_csv 
Функция считывает финансовые операции из CSV

- Функция read_transaction_excel
Функция считывает финансовые операции из Excel

Модуль banking_operations:
- Функция search_transactions для поиска в списке словарей операций по заданной строке - описанию
- Функция sort_transactions Функция для подсчета количества банковских операций определенного типа

Модуль main.py:
- Функция main - отвечает за основную логику проекта и связывает функции между собой
...
Модуль decorators:
- Тестирует корректное выполнение функции и проверяет ошибки
- Тестирует запись в файл после успешного выполнения
- Тестирует запись в файл после ошибки

Модуль utils и external_api:
- Тестирует корректное выполнение функции и проверяет ошибки
- Тестирует на пустой список
- Тестирует если сумма не руб.

Модуль transactions_file:
- Тесты для корректного считывания финансовых операций из CSV и Excel

Модуль banking_operations.py:
- Тесты для корректной работы поиска в списке словарей операций по заданной строке
- Тесты для корректной работы подсчета количества банковских операций определенного типа